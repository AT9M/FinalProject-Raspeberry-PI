...
def music():
    ...
    if comm ==2 | comm==5:
        ...
        call(["espeak",song_of_silence_info])
    else:
        rep="I have no info on this song except that it exist since the start of the phone of Liam but still it was a good song right?"
        call(["espeak",rep])
    return
